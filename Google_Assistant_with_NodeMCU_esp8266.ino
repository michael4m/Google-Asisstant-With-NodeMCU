...
#define WLAN_SSID       "Sumbangan"             // Your SSID ( Wifi Name )
#define WLAN_PASS       "12april1999"        // Your password Wifi

/************************* Adafruit.io Setup *********************************/

#define AIO_SERVER      "io.adafruit.com" //Adafruit Server
#define AIO_SERVERPORT  1883                   
#define AIO_USERNAME    "michael_am"            // Username Adafruit
#define AIO_KEY         "aio_hFzV302qXyO7X06IOZ5HEQBcrGsZ"   // Auth Key Adafruit
int Relay;
//WIFI CLIENT
WiFiClient client;
